      ...
      <div class="vito-title-row">
        <span class="vito-avatar" aria-hidden="true">
          <svg viewBox="88 54 184 188" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <rect x="112" y="110" width="136" height="108" rx="12" fill="var(--robot-screen)"/>
            <ellipse cx="153" cy="154" rx="13" ry="13" fill="var(--robot-eye)"/>
            <ellipse cx="207" cy="154" rx="13" ry="13" fill="var(--robot-eye)"/>
            <path d="M140 178 Q180 200 220 178" stroke="var(--robot-eye)" stroke-width="5" fill="none" stroke-linecap="round"/>
          </svg>
        </span>
        <div>
          <h1>Vito</h1>
