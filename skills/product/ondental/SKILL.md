---
name: ondental-product-spec
description: >
  Especificación completa del producto OnDental — Sistema de Gestión Clínica Dental.
  ...
  Usar este skill siempre que se trabaje en el proyecto OnDental.
version: 1.1.0
author: ONDIGITAL
depends_on:
...
# OnDental — Especificación de Producto

> **OnDental** es una plataforma premium e intuitiva de gestión clínica dental, inspirada
...
- Permite modificar la información básica de la clínica asociada a la empresa actual:
  - **Nombre de la Clínica**: Reemplaza el título del presupuesto (que antes por defecto decía "OnDental"). El PDF y la cabecera del presupuesto llevarán este nombre personalizado.
...
- **Exportación en PDF (`window.print`)**:
  - En lugar de "OnDental", la cabecera muestra en tipografía elegante el `nombreClinica` configurado.
...
5. **Configuración de Clínica y PDF Personalizado**:
   ...
   - Verificar en la vista preliminar de impresión que el título no sea "OnDental" sino `Clínica Dental San Patricio` y que el contacto/ubicación muestre los datos de San Patricio.
